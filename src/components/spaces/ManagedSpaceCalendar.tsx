...
export function ManagedSpaceCalendar({ onPeriodChange, space }: { onPeriodChange: (period: string) => void; space: ManagedSpace }) {
    ...
    const changeMode = (next: SpaceCalendarMode) => setParams({ view: next });
